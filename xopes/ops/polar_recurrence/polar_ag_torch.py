...
class PolarAgTorchFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        ctx.save_for_backward(
            q, alpha, r, beta, s, gamma, log_decay, u_init_state, p_init_state, o
        )
...
def polar_ag_torch(
    ...
    return PolarAgTorchFunction.apply(
        q, alpha, r, norm_style, beta, s, gamma, log_decay, u_state, p_state
    )
