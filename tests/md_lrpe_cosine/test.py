...
from xopes.ops.md_lrpe.cosine import md_lrpe_cosine_cache_triton, md_lrpe_cosine_torch
...
def test(shape, l, dtype):
    ...
    # o_md_lrpe_cosine_triton = md_lrpe_cosine_triton(x, theta, shape=shape[2:-1])
