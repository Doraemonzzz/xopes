...
def test(b, h, n, m, d, e, dtype):
    ...
    # q = torch.ones((b, h, n, d), dtype=dtype, device=device).requires_grad_()
    ...
    # print((o_lao_torch - o_flao_triton)[0, 0, :4])
    # print(o_lao_torch[0, 0, :4, :16])
    # print(o_flao_triton[0, 0, :4, :16])

    # print(torch.norm(o_lao_torch - o_flao_triton))
    # # forward
