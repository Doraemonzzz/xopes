...
from xopes.ops.out_product_linear_recurrence.oplr_no_decay_torch import (
    oplr_no_decay_torch,
)
...
module_map = {
    "torch": oplr_no_decay_torch,
    "torch_compile": torch.compile(oplr_no_decay_torch),
}
...
configs = [
    triton.testing.Benchmark(
        ...
        plot_name=f"oplr_no_decay-{bench_type}-{mode}-batch{b}-dim{d}-dim{e}-{dtype_name}",
        args={
            "b": b,
            "d": d,
            "e": e,
